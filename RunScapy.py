                  ...
                  if file.endswith(".pcap"):
                          ...
                          for packet in a:
                                     ...
                                     if pkt.haslayer(Raw):
                                            ...
                                            msg_size=len(load)
                                            if type_stream==1:
                                                actual_time_msg_u=pkt.getlayer(Raw).time
                                                iat_msg=(actual_time_msg_u-last_time_msg_u)
                                                last_time_msg_u=actual_time_msg_u
                                            else:
                                                actual_time_msg_d=pkt.getlayer(Raw).time
                                                iat_msg=(actual_time_msg_d-last_time_msg_d)
...
if employee_dict:
  ...
  df.sort_values(by=['CaptureNumber','IP'], inplace = True)
